...
Talking about the first segment here.
Awesome and controversial piece.
Watching this only one time is not getting the value.
And general context of watching should be different too so I'd recommend arbitrary time gap between sessions.
Also spoilers here may spoil the second watch too.
...
His assistant is not having a light cruise.
...
Or on another hand darkness of perceived dysfunctionality and movement into nowhere.
Or which one is the nowhere for an artist?
...
Assistant's painting also has it in it.
All this offers rewatchability but I assume the cost of rewatchability is that not all questions will be resolved and it should be expected and tolerated to some extent.

Also if some things or imlications here look a bit far-fetched then
I should say that to do justice to this picture one should watch it in the spirit that it demonstrates.
...
But that is the point I assume.
So at some point I'll get to the ground of such genres too :).
